          ...
          {projects.map((project, idx) => (
            ...
            >
              <div className="space-y-4">
                ...
                {/* Tech Stack string */}
                <p className="text-xs font-semibold text-[#7E8681] pt-2">
                  {project.techList}
                </p>
              </div>
          ...
          {activeModalProject && (
            <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-[#1B201E]/40 backdrop-blur-sm">
              <motion.div
                ...
                className="bg-white border border-[#EFECE6] rounded-3xl max-w-xl w-full p-7 sm:p-9 shadow-2xl relative"
              >
                <button
                ...
                <span className="text-xs font-bold tracking-wider text-[#2D5A43] bg-[#EEF4F0] px-3 py-1 rounded-full uppercase inline-block mb-3">
                  {activeModalProject.category}
                </span>

                <h3 className="text-2xl font-bold text-[#1B201E] mb-4">
                ...
                <div className="space-y-4 text-xs sm:text-sm text-[#4A524D]">
                  ...
                  <div>
                    <strong className="text-[#1B201E] block font-bold mb-1">Technologies:</strong>
                ...
                <div className="mt-6 pt-5 border-t border-[#EFECE6] flex items-center justify-end">
                  <a
